                    ...
                    while( $row = mysqli_fetch_assoc( $selectquery ) )
        {
               ...
               <div class="sort" style="margin-left: 260px; ">
                 <div class="row">
                   <div class="col-sm-5">
                    <br>
                     <h5>Results with High to Low</h5>
                   </div>
                   <!--sort-->
                  ...
                  <div class="">
                     <select onChange="window.location.href=this.value" class="form-control">
                      <option value="listing.php" >Latest</option>
                   <option value="low_high.php">Low-High</option>
                   <option value="" selected>High-Low</option>
...
$query = "SELECT * FROM package_details ORDER BY package_price DESC";
